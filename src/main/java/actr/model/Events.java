...
public class Events
{
	 ...
	 * @return <tt>true</tt> if there are events in the queue, or <tt>false</tt> otherwise
	 */
	 ...
	 * @return <tt>true</tt> if there are events scheduled for the module, or <tt>false</tt> otherwise
	 */
	...
	/**
	 * Checks whether there are any events scheduled for the given module whose description begins
	 * with the given prefix string.
	 * @param module the module string
	 * @param prefix the prefix string
	 * @return <tt>true</tt> if there are events scheduled for the module with the given prefix,
