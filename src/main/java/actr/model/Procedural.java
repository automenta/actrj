...
public class Procedural extends Module
{
	 ...
	 * @return the iterator
	 */
	public Iterator<Production> getProductions () { return productions.values().iterator(); }
	...
	void fire (Instantiation inst, Buffers buffers)
	{
		...
		if (utilityLearning)
		{
			...
			if (rewardFirings.size() > 100) rewardFirings.removeElementAt (0);
		}
	...
	/** 
	 * Gets a string representation of the procedural store including all productions. 
	 * @return the string
	 */
