...
/**
 * An instantiation of a production rule specified as a mapping from variables to values.
 *  
...
public class Instantiation
{
	 ...
	 * @return the value as a symbol (which can be retrieved from declarative memory for the
	 * full chunk if desired)
	 */
	 ...
	 */
	public Production getProduction () { return p; }
	...
	/** 
	 * Gets a string representation of the instantiation as the mapping of variables to values. 
	 * @return the string
	 */
