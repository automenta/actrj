...
class Brain extends JPanel
{
	...
	private final Image images[] = {
			Resources.getImage ("brain1.png"),
			Resources.getImage ("brain2.png"),
	...
	Brain (final Frame frame)
	{
		...
		// regions from Anderson, Qin, Jung, & Carter, Cognitive Psychology, 2007
		...
		regions.add (new Region ("goal", 5, 10, 38, Color.green)); // anterior cingulate
		regions.add (new Region ("procedural", 15, 9, 2, Color.magenta)); // caudate
		regions.add (new Region ("visual", 42, -60, -8, Color.blue)); // fusiform gyrus
		regions.add (new Region ("aural", 47, -22, 4, Color.green)); // auditory cortex
