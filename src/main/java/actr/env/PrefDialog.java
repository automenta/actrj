...
class PrefDialog extends JDialog
{
	...
	private JComboBox fontCB, fontSizeCB;
	private JCheckBox autoHiliteCB, autoIndentCB;
	private ColorButton commandColorButton, parameterColorButton, productionColorButton,
	chunkColorButton, bufferColorButton, commentColorButton;
	private JComboBox indentSpacesCB;
	...
	class ColorButton extends JButton
	{
		...
		void refresh () { panel.setBackground (getColor()); repaint(); }
	}
	...
	PrefDialog (final Core core)
	{
		...
		commandColorButton = new ColorButton() {
			Color getColor() { return prefs.commandColor; }
			void setColor (Color color) { prefs.commandColor = color; }
		};
		parameterColorButton = new ColorButton() {
			Color getColor() { return prefs.parameterColor; }
			void setColor (Color color) { prefs.parameterColor = color; }
		};
		productionColorButton = new ColorButton() {
			Color getColor() { return prefs.productionColor; }
			void setColor (Color color) { prefs.productionColor = color; }
		};
		chunkColorButton = new ColorButton() {
			Color getColor() { return prefs.chunkColor; }
			void setColor (Color color) { prefs.chunkColor = color; }
		};
		bufferColorButton = new ColorButton() {
			Color getColor() { return prefs.bufferColor; }
			void setColor (Color color) { prefs.bufferColor = color; }
		};
		commentColorButton = new ColorButton() {
			Color getColor() { return prefs.commentColor; }
			void setColor (Color color) { prefs.commentColor = color; }
		};
